...
|---|---|
| **Platform** | TikTok/Reels, YouTube Shorts, YouTube long-form, Podcast | Dictates structure, length, hook style, CTA placement |
| **Content type** | Thought leadership/POV, Educational/how-to, UGC-style | Determines tone, scripting level, and arc |
| **Topic / core idea** | What the video is actually about | The seed of the script |
| **Target audience** | Who is watching — role, level, pain points | Shapes language, framing, and examples |
| **Desired length** | Approximate duration in seconds or minutes | Controls density and number of beats |
...
1. **3-second rule for short-form:** The first 3 seconds determine algorithmic distribution. The hook must create immediate curiosity, tension, or value.
2. **30-second rule for long-form:** Retain ~70%+ of viewers by the 30-second mark or the algorithm de-prioritizes.
3. **No throat-clearing.** No "Hey guys," no logo stings, no long self-introductions before the hook. Lead with value or tension.
4. **Hook-to-body alignment.** The hook promise must match the body content. Misaligned hooks cause retention cliffs. Restate the hook promise in clearer terms within the first few seconds of the body.
...
- Mark performance cues in brackets: `[pause]`, `[lean in]`, `[show screen]`, `[cut to B-roll]`, `[emphasis]`.
...
1. **Hook variants** — "Want me to write 2–3 alternative hooks to test?"
2. **Platform adaptation** — "Want me to adapt this for [other platform]?"
3. **Length adjustment** — "Want a shorter/longer version?"
4. **Tone shift** — "Want a more provocative / conversational / vulnerable version?"
